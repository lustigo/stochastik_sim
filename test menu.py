...
print(var1.get())
#root.mainloop()
startbutton=Button(root,text='Start',font=('Arial',40),bg='blue',borderwidth=5)       #command=
startbutton.place(x=0,y=int(y)-100,width=int(y)-200,height=100)
csvbutton=Button(root,text='Export CSV',font=('Arial',40),bg='green',borderwidth=5)
